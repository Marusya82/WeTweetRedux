...
public class MentionsDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static MentionsDatabaseHelper sInstance;

    // Database Info
    private static final String DATABASE_NAME = "mentionsDatabase";
    private static final int DATABASE_VERSION = 1;

    // Table Name
    private static final String TABLE_MENTIONS = "tweets";
    ...
    public static synchronized MentionsDatabaseHelper getInstance(Context context) {
        // Use the application context, which will ensure that you don't accidentally leak an Activity's context.
        if (sInstance == null) {
            sInstance = new MentionsDatabaseHelper(context.getApplicationContext());
        }
        return sInstance;
    }
     ...
     */
    private MentionsDatabaseHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TWEETS_TABLE = "CREATE TABLE " + TABLE_MENTIONS +
                "(" +
    ...
    public void addAll(ArrayList<Tweet> tweets) {
        ...
        try {
            for (Tweet tweet: tweets) {
                ...
                db.insertOrThrow(TABLE_MENTIONS, null, values);
    ...
    public ArrayList<Tweet> getAll() {
        ...
        // SELECT * FROM TASKS
        String TWEETS_SELECT_QUERY = String.format("SELECT * FROM %s", TABLE_MENTIONS);
    ...
    public void deleteAll() {
        ...
        db.beginTransaction();
        try {
            db.delete(TABLE_MENTIONS, null, null);
            db.setTransactionSuccessful();
        } catch (Exception e) {
