...
* [x] Heterogenious layouts for different types of tweets
* [x] Basic error handling (checking for network connectivity, firing snackbars)

#### Video Walkthrough

![Alt Text](https://github.com/Marusya82/Articlist/blob/master/WeTweet_demo.gif)
